...
import { LayoutDashboard, MapPin, ClipboardList, Users, Wallet } from 'lucide-react'

const navItems = [
  { icon: LayoutDashboard, label: 'Dashboard',      path: '/' },
  { icon: MapPin,          label: 'Mapa de Baches', path: '/mapa' },
  { icon: ClipboardList,   label: 'Reportes',        path: '/reportes' },
  { icon: Users,           label: 'Reparadores',     path: '/reparadores' },
    ...
    <div style={{
      ...
      <div style={{ padding: '16px', borderTop: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ color: 'white', fontSize: '13px', fontWeight: 500 }}>Administrador</div>
          <span style={{
            display: 'inline-block',
            fontSize: '10px',
            fontWeight: 500,
            color: 'white',
            background: 'var(--oax-turquesa)',
            padding: '1px 6px',
            borderRadius: '999px',
            marginTop: '2px',
          }}>Autoridad</span>
